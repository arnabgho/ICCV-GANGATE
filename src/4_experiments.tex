...
\begin{tabular}{*{5}{c@{\hspace{3px}}}}
    \frame{\includegraphics[width=.25\linewidth]{images/shoe_autocomplete_render/current_scribble_3.jpg}} &
    %\frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/soccer.png}} &
    \frame{\includegraphics[width=.25\linewidth]{images/shoe_autocomplete_render/current_scribble_4.jpg}} & 
    \frame{\includegraphics[width=.25\linewidth]{images/face_autocomplete_render/current_scribble_4.jpg}}&
    \frame{\includegraphics[width=.25\linewidth]{images/face_autocomplete_render/current_scribble_5.jpg}} &
    \\
    \frame{\includegraphics[width=.25\linewidth]{images/shoe_autocomplete_render/autocompleted_sketch_3.png}} &
    %\frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/soccer.png}} &
    \frame{\includegraphics[width=.25\linewidth]{images/shoe_autocomplete_render/autocompleted_sketch_4.png}} & 
    \frame{\includegraphics[width=.25\linewidth]{images/face_autocomplete_render/autocompleted_sketch_4.png}}&
    \frame{\includegraphics[width=.25\linewidth]{images/face_autocomplete_render/autocompleted_sketch_5.png}} &
   
    \\
    \frame{\includegraphics[width=.25\linewidth]{images/shoe_autocomplete_render/rendered_3.png}} &
    %\frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/soccer.png}} &
    \frame{\includegraphics[width=.25\linewidth]{images/shoe_autocomplete_render/rendered_4.png}} & 
    \frame{\includegraphics[width=.25\linewidth]{images/face_autocomplete_render/rendered_4.png}}&
    \frame{\includegraphics[width=.25\linewidth]{images/face_autocomplete_render/rendered_5.png}} &
...
\cameraready{\paragraph{Results} As we can see the results in Figure \figref{fig:autocomplete_generate_sketches} our 2 step technique allows us to complete the simplified edge maps from the partial strokes and also generate realistic images from the autocompleted simplified edges.
...
\cameraready{ \subsection{Multi Class Generation} }
