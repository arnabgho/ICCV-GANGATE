...
However, one challenge of using a simplified dataset is that multiple object classes can have similar outlines (e.g., cookie, basketball, soccer, orange, moon are all round).
