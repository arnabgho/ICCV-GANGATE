\begin{abstract}
In this work, we propose an interface where a GAN agent assists a casual user to draw simple objects. 
The user adds sparse scribbles for the object shape, and a GAN agent completes these scribbles into a full object shape. 
It then performs a translation from completed shape to image.
