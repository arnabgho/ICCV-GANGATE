...
We use sparse object outlines/sparse sketches instead of dense edge maps as the user input, as these are closer to lines that novice users tend to draw~\cite{cole2008people}. 
Our model first completes the partial outline/sketch and then generates the image conditioned on the completed shape. There are several advantages to this two-stage approach.
