...
\begin{center}
    ...
    \vspace{-6mm}
    \captionof{figure}{({\bf Top}) Given sparse user input (first row), our model estimates the complete shape and provides this a recommendation to the user (shown in gray), along with the final drawn object (second row). These estimates are updated as the user adds strokes (shown in \textcolor{green}{green}), and removes strokes (shown in \textcolor{red}{red}) -- previous edits are shown in black.
