...
\begin{figure*}[ht]%[ht!]
\centering
\begin{tabular}{*{10}{c@{\hspace{3px}}}}
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/basketball.png}} &
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/soccer.png}} &
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/watermelon.png}} & 
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/orange.png}}&
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/cookie.png}} &
    ...
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/scribble/pineapple.png}} &
    ...
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/autocomplete/basketball.png}} &
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/autocomplete/soccer.png}} &
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/autocomplete/watermelon.png}} & 
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/autocomplete/orange.png}}&
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/autocomplete/cookie.png}} &
    ...
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/autocomplete/pineapple.png}} &
    ...
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/image/basketball.png}} &
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/image/soccer.png}} &
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/image/watermelon.png}} & 
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/image/orange.png}}&
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/image/cookie.png}} &
    ...
    \frame{\includegraphics[width=.10\linewidth]{images/autocomplete_generate/image/pineapple.png}} &
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{paper_images/isf_method_v2.pdf}
...
\section{Method}
We decouple the problem of interactive image generation into two stages: shape completion from sparse user strokes, and appearance synthesis from the completed outlines. \es{we need to refer to Fig.~\ref{fig:SketchFillNet} and use it's terminology $G_S$, $G_A$, ...}
...
The shape completion network should provide the user with a visualization of its best guess for the completed shape, based on the available input from the user and updated interactively. 
...
To train this network, we simulate partial strokes by removing random square patches of different size from the full outline image. \es{probably need more details here - size of squares, how many per image, total training data size etc.}
...
However, a more powerful method would be to apply this weighting channel-wise using a vector {\boldmath$\alpha$}: % This is denoted as follows:
\begin{align}
...
We additionally explored incorporating shifting after the soft-gating, either block-wise using a scalar $\beta \in [-1,1]$ per layer, or channel-wise using a vector $\mbox{\boldmath $\beta$} \in [-1, 1]^c$ per layer.
...
We demonstrate the intuition behind this type of gating by a toy experiment \figref{fig:onedexperiment} where a generative network models a one dimensional mixture of Gaussians, comprised of five components. 
